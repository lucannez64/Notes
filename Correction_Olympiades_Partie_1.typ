...
#label("démonstration-des-bornes-du-score")
-  Score minimum \= 0. C’est le cas quand la liste est triée dans
  l’ordre croissant, il n’y a alors aucune inversion.
...
#label("existence-dune-liste-de-score-k")
#block[
#set enum(numbering: "a.", start: 1)
...
#label("formules-pour-l_n0-et-l_nn-1")
...
générale)
#label("exercice-2-candidats-suivant-lenseignement-de-spécialité-de-la-voie-générale")
=== Partie 1
#label("partie-1")
+  b \= -(r1 + r2) \
  c \= r1\*r2
