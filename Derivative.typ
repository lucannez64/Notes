...
$frac(d, d x) f lr((g lr((x)))) eq frac(d f, d x) lr((g lr((x)))) dot frac(d g, d x) lr((x))$
$eq f prime lr((g lr((x)))) dot g prime lr((x))$

Example:

$f lr((x)) eq space i n lr((x))$ \
$g lr((x)) eq x^3$ \
$f lr((g lr((x)))) eq space i n lr((x^3))$ \
$f prime lr((g lr((x)))) eq 3 c o space lr((x^3)) x^2$
